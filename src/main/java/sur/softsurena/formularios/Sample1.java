...
public class Sample1 extends AbstractReportGenerator {
  ...
  public MasterReport getReportDefinition() {
    try {
      ...
      File file = new File("reportes/ReporteCorto.prpt");
  ...
  public static void main( String[] args ) throws IOException, ReportProcessingException {
    ...
    final File outputFilename = new File( "reportes/"+Sample1.class.getSimpleName() + ".xlsx" );

    // Generate the report
    new Sample1().generateReport( AbstractReportGenerator.OutputType.EXCEL, outputFilename );
